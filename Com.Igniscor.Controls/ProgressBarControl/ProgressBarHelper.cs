...
{
    public static void SetClip(SKCanvas canvas, SKImageInfo info, float outerCornerRadius)
    {
    ...
    public static void DrawBackground(SKCanvas canvas, ProgressBarOrientation orientation, SKImageInfo info,
        float outerCornerRadius, SKColor startColor, SKColor endColor)
    {
        ...
        paint.Shader = SKShader.CreateLinearGradient(startPoint, endPoint, new[] { startColor, endColor },
            new float[] { 0, 1 }, SKShaderTileMode.Clamp);

        canvas.DrawRoundRect(backgroundBar, paint);
    }

    public static void DrawProgress(SKCanvas canvas, ProgressBarOrientation orientation, SKImageInfo info,
    ...
    public static void DrawText(SKCanvas canvas, ProgressBarOrientation orientation, SKImageInfo info,
    ...
    private static SKRoundRect CreateRoundRect(int right, int bottom, float cornerRadius) =>
        new(new SKRect(0, 0, right, bottom), cornerRadius, cornerRadius);
}